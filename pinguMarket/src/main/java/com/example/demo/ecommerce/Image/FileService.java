...
public class FileService {
	...
	public Integer save(HttpServletRequest request, MultipartFile files) throws Exception {
		...
		String fileUrl = "C:\\Users\\504호\\git\\TotalPlatform_LMS3\\pinguClass\\src\\main\\resources\\static\\img\\"; //파일이 저장되는 서버 공간
		...
		com.example.demo.ecommerce.Entity.Image f = new com.example.demo.ecommerce.Entity.Image();
